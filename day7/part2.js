const cardHierarchy = 'AKQT98765432J'.split('').reverse();
...
const gameResults = lines.map((line) => {
	...
	let cardWorth = 0;
	const ultimateMultiplier = 10000000000000000;
	if (cardPool[0][1] === 5) {
	...
	let cardAdditionMultiplier = 100000000000;
...
sortedGameResults.forEach((gameResult, i) => {
	...
	console.log(gameResult.cardWorth, gameResult.bid, gameResult.hand);
})
